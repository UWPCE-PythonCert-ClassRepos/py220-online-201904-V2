...
class Department(BaseModel):
    ...
    logger.info('Which job held under the Dept')
    job_held = ForeignKeyField(Job, primary_key=True, related_name='was_filled_by', null=False)
    logger.info('Job Duration')
    job_duration = DecimalField(max_digits = 7, decimal_places = 0)
