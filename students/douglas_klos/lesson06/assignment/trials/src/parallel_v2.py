...
def analyze_first_half(found, _2013, _2014, _2015, _2016, _2017, _2018, dataset):
...
def analyze_second_half(found, _2013, _2014, _2015, _2016, _2017, _2018, dataset):
...
def main():
    ...
    for loop in range(10):
        ...
        process1 = Process(target=analyze_first_half, args=(found, _2013, _2014, _2015, _2016, _2017, _2018, csvfile))
        process2 = Process(target=analyze_second_half, args=(found, _2013, _2014, _2015, _2016, _2017, _2018, reversed(csvfile)))
        process1.start()
        process2.start()
