...
def import_data(directory_name, product_file, customer_file, rentals_file):
    ...
    processed_products = import_count[0] + error_count[0]
    processed_customers = import_count[1] + error_count[1]
    ...
    products_tuple = (processed_products, record_int_products, record_end_products, total_time_products)
    customers_tuple = (processed_customers, record_int_customers, record_end_customers, total_time_customers)
...
def main():
    ...
    print(import_data(parent_directory, "/data/product.csv", "/data/customer.csv", "/data/rental.csv"))
