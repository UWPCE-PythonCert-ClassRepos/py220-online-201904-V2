...
def disable_logging(func):
    """
    decorator function to turn on/off logging
    """
...
def parse_cmd_arguments():
    ...
    parser.add_argument("-l", "--logger", help="logger level", required=False)
    parser.add_argument("-d", "--disable", help = "disable logger", required = False, action='store_true')
...
def set_logging_level(debug_level):
    ...
    """
    logging.info('Start Debug: set_logging_level(debug_level)')
