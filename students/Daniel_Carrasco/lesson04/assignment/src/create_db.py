...
def parse_cmd_arguments():
    ...
    parser.add_argument("-csv", "--csv", help="input csv name to create database", required=False)
    parser.add_argument("-print", "--print", help="input csv name to create database", required=False)
...
def create_csvdb(csv):
    ...
    [l.add_customer(customer[0],customer[1],customer[2],customer[3],customer[4],customer[5],customer[6],customer[7])   for customer in customers]
    return customers
