...
from inventory_management.electricappliancesclass\
...
class ElectricappliancesTest(TestCase):
    ...
    def test_eacdict(self):
        ...
        test_dict = {
            ...
            'brand': 'TEST',
            'voltage': '321'}
        input_dict = eac('AB123', 'TEST', '150.00', '50.25',
                         'TEST', '321').returnasdictionary()
...
class FurnitureclassTest(TestCase):
    ...
    def test_fcdict(self):
        ...
        test_dict = {
            ...
            'material': 'TEST',
            'size': '321'}
        input_dict = fc('AB123', 'TEST', '150.00', '50.25',
                        'TEST', '321').returnasdictionary()
        self.assertEqual(input_dict, test_dict)
