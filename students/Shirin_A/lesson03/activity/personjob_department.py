...
depts = [
    ...
    ('A777', 'Sales', 'Jose', '2001-09-22', '2003-01-30', 'Andrew'),

    ('F998', 'Engineering', 'Juan', '2003-02-01', '2006-10-22', 'Andrew'),

    ('T223', 'Horses', 'Matt', '2006-10-23', '2016-12-24', 'Andrew'),

    ('B223', 'Walrus', 'John', '2012-10-01', '2014-11,10', 'Peter'),

    ('M745', 'Toliet', 'Xander', '2014-11-14', '2018-01-05', 'Peter')
